          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start rtl:justify-end">
              ...
              <a href="#" className="flex ms-2 md:me-24">
                <img src={logo} className="h-8 me-3" alt="Uet Logo" />
      ...
      >
        <div className="h-full px-3 pb-4 overflow-y-auto bg-[#6f5cc3]">
          <ul className="space-y-2 font-medium">
            <li>
              <Link to="/SupervisorDashboard" className="flex items-center p-2 text-white rounded-lg hover:bg-[#5a2b96] group">
                <svg
            ...
            <li>
              <Link to="/SupervisorProfile" className="flex items-center p-2 text-white rounded-lg hover:bg-[#5a2b96] group">
            ...
            <li>
              <Link to="/SupervisorProjectRequest" className="flex items-center p-2 text-white rounded-lg hover:bg-[#5a2b96] group">
                <svg xmlns="http://www.w3.org/2000/svg" width="1.2em" height="1.2em" viewBox="0 0 24 24">
            ...
            <li>
              <Link to="/SupervisorProjectsUnderMe" className="flex items-center p-2 text-white rounded-lg hover:bg-[#5a2b96] group">
                <svg xmlns="http://www.w3.org/2000/svg" width="1.2em" height="1.2em" viewBox="0 0 24 24">
            ...
            <li>
              <button
                className="flex items-center p-2 text-white rounded-lg hover:bg-[#5a2b96] group w-full"
