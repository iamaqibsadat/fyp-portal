      ...
      >
        <div className="h-full px-3 pb-4 overflow-y-auto bg-[#6f5cc3]">
          <ul className="space-y-2 font-medium">
            <li>
              <Link to="/StudentDashboard" className="flex items-center p-2 text-white rounded-lg hover:bg-[#5a2b96] group">
                <svg
            ...
            <li>
              <Link to="/StudentProfile" className="flex items-center p-2 text-white rounded-lg hover:bg-[#5a2b96] group">
            ...
            <li>
              <Link to="/StudentProjectCreation" className="flex items-center p-2 text-white rounded-lg hover:bg-[#5a2b96] group">
                <svg xmlns="http://www.w3.org/2000/svg" width="1.2em" height="1.2em" viewBox="0 0 24 24">
            ...
            <li>
              <Link to="/StudentProject" className="flex items-center p-2 text-white rounded-lg hover:bg-[#5a2b96] group">
                <svg xmlns="http://www.w3.org/2000/svg" width="1.2em" height="1.2em" viewBox="0 0 24 24">
